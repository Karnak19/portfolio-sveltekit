	...
	<main class="bg-white/60 backdrop-blur-xl p-10 grid gap-2 rounded-md border-2 border-white/20">
		<div class="grid place-items-center">
			<img
				...
				alt="Basile Vernouillet portrait" />
		</div>
		...
		<div id="socials" class="grid place-items-center border-t-2 border-white pt-4">
			<ul class="flex w-full justify-between">
				<li>
					<a target="_blank" rel="noopener noreferrer" href="https://github.com/Karnak19">
						<Icon title="github">
							<path
				...
				<li>
					<a target="_blank" rel="noopener noreferrer" href="https://twitter.com/BVernouillet">
						<Icon title="Twitter">
							<path
